        ...
        <div className="container mx-auto">
          ...
          <div className="grid  lg:grid-cols-2 2xl:grid-cols-3 gap-16">
            {projects.length > 0 ? (
              projects.map((el) => {
                return (
                  <div key={el.title} className="bg-color2 rounded-sm w-full overflow-hidden p-4 flex flex-col">
                    ...
                    <a href={el.url} target="_blank" rel="noreferrer" className="ml-auto bg-color5 text-color4 p-2 rounded-sm">
                      Visit this project
                    </a>
                  </div>
                );
